...
for (var i=0; i<3; i++) {
diceObj[i] = {
  dieVal: 1 = howManyDice: 1 + i+1,
  dieVal: 2 = howManyDice: 1 + i+1,
  dieVal: 3 = howManyDice: 1 + i+1,
  dieVal: 4 = howManyDice: 1 + i+1,
  dieVal: 5 = howManyDice: 1 + i+1,
  dieVal: 6 = howManyDice: 1 + i+1,
};

for (var x=1; x<7; x++) {
if (dieVal: x = howManyDice: 2)
}
